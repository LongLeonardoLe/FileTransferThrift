...
public class FileTransfer {
  ...
  public interface Iface {
    ...
    public java.util.List<java.util.List<java.lang.Long>> sendMetaData(Metadata header) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void sendMetaData(Metadata header, org.apache.thrift.async.AsyncMethodCallback<java.util.List<java.util.List<java.lang.Long>>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_sendMetaData(Metadata header) throws org.apache.thrift.TException
    {
      ...
      sendBase("sendMetaData", args);
    }

    public java.util.List<java.util.List<java.lang.Long>> recv_sendMetaData() throws org.apache.thrift.TException
    {
      sendMetaData_result result = new sendMetaData_result();
      receiveBase(result, "sendMetaData");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "sendMetaData failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class sendMetaData_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<java.util.List<java.lang.Long>>> {
      private Metadata header;
      public sendMetaData_call(Metadata header, org.apache.thrift.async.AsyncMethodCallback<java.util.List<java.util.List<java.lang.Long>>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.header = header;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("sendMetaData", org.apache.thrift.protocol.TMessageType.CALL, 0));
        sendMetaData_args args = new sendMetaData_args();
        args.setHeader(header);
        args.write(prot);
      ...
      public java.util.List<java.util.List<java.lang.Long>> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_sendMetaData();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class sendMetaData<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sendMetaData_args> {
      ...
      public sendMetaData_result getResult(I iface, sendMetaData_args args) throws org.apache.thrift.TException {
        sendMetaData_result result = new sendMetaData_result();
        result.success = iface.sendMetaData(args.header);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sendMetaData<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sendMetaData_args, java.util.List<java.util.List<java.lang.Long>>> {
      public sendMetaData() {
        super("sendMetaData");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<java.util.List<java.lang.Long>>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<java.util.List<java.lang.Long>>>() { 
          public void onComplete(java.util.List<java.util.List<java.lang.Long>> o) {
            sendMetaData_result result = new sendMetaData_result();
            result.success = o;
            try {
      ...
      public void start(I iface, sendMetaData_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<java.util.List<java.lang.Long>>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class sendMetaData_result implements org.apache.thrift.TBase<sendMetaData_result, sendMetaData_result._Fields>, java.io.Serializable, Cloneable, Comparable<sendMetaData_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("sendMetaData_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.LIST, (short)0);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new sendMetaData_resultStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new sendMetaData_resultTupleSchemeFactory();

    public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.Long>> success; // required
    ...
    static {
      ...
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(sendMetaData_result.class, metaDataMap);
    }

    public sendMetaData_result() {
    }

    public sendMetaData_result(
      java.util.List<java.util.List<java.lang.Long>> success)
    {
      this();
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public sendMetaData_result(sendMetaData_result other) {
      if (other.isSetSuccess()) {
        java.util.List<java.util.List<java.lang.Long>> __this__success = new java.util.ArrayList<java.util.List<java.lang.Long>>(other.success.size());
        for (java.util.List<java.lang.Long> other_element : other.success) {
          java.util.List<java.lang.Long> __this__success_copy = new java.util.ArrayList<java.lang.Long>(other_element);
    ...
    public sendMetaData_result deepCopy() {
      return new sendMetaData_result(this);
    }
    ...
    public java.util.Iterator<java.util.List<java.lang.Long>> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(java.util.List<java.lang.Long> elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<java.util.List<java.lang.Long>>();
      }
      this.success.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<java.util.List<java.lang.Long>> getSuccess() {
      return this.success;
    }

    public sendMetaData_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.lang.Long>> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<java.util.List<java.lang.Long>>)value);
        }
        break;
    ...
    public boolean equals(java.lang.Object that) {
      if (that == null)
        return false;
      if (that instanceof sendMetaData_result)
        return this.equals((sendMetaData_result)that);
      return false;
    }

    public boolean equals(sendMetaData_result that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(sendMetaData_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("sendMetaData_result(");
      boolean first = true;
    ...
    private static class sendMetaData_resultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public sendMetaData_resultStandardScheme getScheme() {
        return new sendMetaData_resultStandardScheme();
      }
    }

    private static class sendMetaData_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<sendMetaData_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, sendMetaData_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<java.util.List<java.lang.Long>>(_list0.size);
                  @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> _elem1;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendMetaData_result struct) throws org.apache.thrift.TException {
        struct.validate();
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (java.util.List<java.lang.Long> _iter6 : struct.success)
            {
              {
    ...
    private static class sendMetaData_resultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public sendMetaData_resultTupleScheme getScheme() {
        return new sendMetaData_resultTupleScheme();
      }
    }

    private static class sendMetaData_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<sendMetaData_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, sendMetaData_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (java.util.List<java.lang.Long> _iter8 : struct.success)
            {
              {
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, sendMetaData_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<java.util.List<java.lang.Long>>(_list10.size);
            @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> _elem11;
